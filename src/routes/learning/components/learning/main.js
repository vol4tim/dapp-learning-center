...
const Main = function(props) {
  return <div>
    <h1>Урок {props.number}: {props.name}</h1>
    {props.isExecute ?
      <Result><p>Урок выполнен</p></Result>
      :
      <div>
        <ul className="nav nav-tabs nav-justified">
          <li role="presentation" className="active"><a href="#tab1" role="tab" data-toggle="tab">Выполнение урока</a></li>
          <li role="presentation"><a href="#tab2" role="tab" data-toggle="tab">Проверка умений</a></li>
        </ul>
        <div className="tab-content">
          <div role="tabpanel" className="tab-pane active" id="tab1" style={{paddingTop: 20}}>
            ...
            <div className="col-xs-4">
              ...
              {props.progress.map(function(item, index) {
            ...
            <div className="col-xs-8">
              ...
              <Result><p dangerouslySetInnerHTML={{__html: props.formResult.message}} /></Result>
              }
            </div>
            </div>
          </div>
